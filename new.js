...
function q1(){
    var question1 = prompt('do you know me(y/n)?')
...
function q2(){
    var question2 = prompt('do you have my number(y/n))?')
...
q2();
function q3(){
    var question3 = prompt('did you get my facebook(y/n)?')
...
q3();
function q4(){
    var question4 = prompt('did you get my linkedin(y/n)?')
...
q4();
function q5(){
    var question5 = prompt('do you know my major (y/n)?')
